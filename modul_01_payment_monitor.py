...
RESOURCES = {
    ...
    "dau_tu": {
        ...
        "table": "dau_tu",
        "order": "loai, id DESC",
        "badge": "loai", "countdown": None,
        "cols": [
            {"k": "hang_muc", "l": "Hạng mục", "t": "text"},
            {"k": "loai", "l": "Loại", "t": "select", "opts": ["bat_dong_san", "khoan_vay", "khac"]},
            {"k": "gia_tri", "l": "Giá trị", "t": "number", "money": True},
            {"k": "dong_tien_thang", "l": "Dòng tiền/tháng", "t": "number", "money": True},
            {"k": "ghi_chu", "l": "Ghi chú", "t": "text"},
        ],
        "actions": [],
    },
    "xay_sua": {
        ...
        "table": "xay_sua",
        "order": "id DESC",
        "badge": "trang_thai", "countdown": None,
        "cols": [
            {"k": "hang_muc", "l": "Hạng mục", "t": "text"},
            {"k": "ma_phong", "l": "Phòng", "t": "text"},
            {"k": "chi_phi_du_kien", "l": "CP dự kiến", "t": "number", "money": True},
            {"k": "chi_phi_thuc", "l": "CP thực", "t": "number", "money": True},
            {"k": "trang_thai", "l": "Trạng thái", "t": "select", "opts": ["ke_hoach", "dang_lam", "xong"]},
            {"k": "ngay", "l": "Ngày", "t": "date"},
            {"k": "ghi_chu", "l": "Ghi chú", "t": "text"},
        ],
        "actions": [],
    },
    "phong_thuy": {
        ...
        "table": "phong_thuy",
        "order": "id DESC",
        "badge": "nguoi_tu_van", "countdown": None,
        "cols": [
            {"k": "doi_tuong", "l": "Đối tượng", "t": "text"},
            {"k": "noi_dung", "l": "Nội dung tư vấn", "t": "text"},
            {"k": "ngay", "l": "Ngày", "t": "date"},
            {"k": "nguoi_tu_van", "l": "Người tư vấn", "t": "text"},
            {"k": "ghi_chu", "l": "Ghi chú", "t": "text"},
        ],
        "actions": [],
    },
    "mua_ban": {
        ...
        "badge": "trang_thai", "countdown": None,
        "cols": [
            {"k": "loai", "l": "Loại", "t": "select", "opts": ["mua", "ban", "ky_gui"]},
            {"k": "tai_san", "l": "Tài sản", "t": "text"},
            {"k": "gia", "l": "Giá", "t": "number", "money": True},
            {"k": "khach", "l": "Khách", "t": "text"},
            {"k": "trang_thai", "l": "Trạng thái", "t": "select", "opts": ["moi", "dang_dam_phan", "xong", "huy"]},
            {"k": "ngay", "l": "Ngày", "t": "date"},
            {"k": "ghi_chu", "l": "Ghi chú", "t": "text"},
        ],
        "actions": [],
